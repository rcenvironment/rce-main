...
public class InOutputConfigurationPage extends ToolIntegrationWizardPage {
    ...
    public static final String FOLDER = IntegrationConstants.KEY_ENDPOINT_FOLDER;

    /** Key for in-/output from configuration map. */
    public static final String DATA_TYPE = IntegrationConstants.KEY_ENDPOINT_DATA_TYPE;

    /** Key for in-/output from configuration map. */
    public static final String NAME = IntegrationConstants.KEY_ENDPOINT_NAME;

    /** Key for in-/output from configuration map. */
    public static final String FILENAME = IntegrationConstants.KEY_ENDPOINT_FILENAME;

    /** Key for in-/output from configuration map. */
    public static final String USAGE = ToolIntegrationConstants.KEY_ENDPOINT_USAGE;

    /** Key for in-/output from configuration map. */
    public static final String HANDLING = IntegrationConstants.KEY_INPUT_HANDLING;

    /** Key for in-/output from configuration map. */
    public static final String CONSTRAINT = IntegrationConstants.KEY_INPUT_EXECUTION_CONSTRAINT;

    /** Key for in-/output from configuration map. */
    public static final String DEFAULT_HANDLING = IntegrationConstants.KEY_DEFAULT_INPUT_HANDLING;

    /** Key for in-/output from configuration map. */
    public static final String DEFAULT_CONSTRAINT = IntegrationConstants.KEY_DEFAULT_INPUT_EXECUTION_CONSTRAINT;

    /** Key for the input keyword. */
    public static final String INPUTS = IntegrationConstants.KEY_ENDPOINT_INPUTS;

    private static final String HELP_CONTEXT_ID = "de.rcenvironment.core.gui.wizard.toolintegration.integration_inputOutput";

    private static final String OUTPUTS = IntegrationConstants.KEY_ENDPOINT_OUTPUTS;
