 ...
 * @author Sascha Zur
 */
public class CpacsWriterHistoryDataItemSubtreeBuilder implements ComponentHistoryDataItemSubtreeBuilder {
    ...
    public String[] getSupportedHistoryDataItemIdentifier() {
        return new String[] { CpacsWriterComponentConstants.COMPONENT_ID };
    }
        ...
        if (historyDataItem instanceof String) {
            ...
            try {
                historyData = XmlComponentHistoryDataItem.fromString((String) historyDataItem,
                    serializer, CpacsWriterComponentConstants.COMPONENT_ID);
            } catch (IOException e) {
            ...
            if (historyData.getXmlWithVariablesFileReference() != null) {
                ...
                DMBrowserNode cpacsWithVariablesFileNode =
                    DMBrowserNode.addNewLeafNode("cpacsWithVariables.xml", DMBrowserNodeType.DMFileResource, mappingWithVariablesNode);
